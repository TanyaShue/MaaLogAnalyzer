...
export const buildSearchExecutorOptions = (
  ...
  sourceLoadGeneration: context.sourceLoadGeneration,
  sourceIntentGeneration: context.sourceIntentGeneration,
  sourceMode: context.sourceMode,
  prepareSourceMode: context.prepareSourceMode,
...
export const buildFileRuntimeOptions = (
  ...
  isSearching: context.isSearching,
  searchRequestGeneration: context.searchRequestGeneration,
  resetSearchResultsOnly: context.resetSearchResultsOnly,
  searchText: context.searchText,
  fileName: context.fileName,
  fileContent: context.fileContent,
